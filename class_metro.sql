CREATE TABLE metro_info(id int not null unique,station_name varchar(50),lineno varchar(10),Train_type varchar(50),
arrival_time time,departure_time time,platform_no int,is_operational boolean,last_maintanance_date date,capacity int,
constraint station_name_uni unique(station_name),constraint capacity_chk check(capacity>4000),
constraint platform_no_chk check(platform_no>1));
