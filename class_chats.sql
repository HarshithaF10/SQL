...
available_chats varchar(30),c_profit bigint,selling_chat bigint,c_loc varchar(20),c_menu varchar(20),c_customer_day int,
c_employer int,constraint c_menu_uni unique(c_menu),constraint c_customer_day_chk check(c_customer_day>1),
constraint c_profit_chk check(c_profit>500));
desc chat_center;
